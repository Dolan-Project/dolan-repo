...
import type { AuthAdapter, AuthProviderUser } from "./auth-adapter.ts";

export const MOCK_TOKENS: Record<string, AuthProviderUser> = {
...
export class MockAuthAdapter implements AuthAdapter {
  async validateAccessToken(accessToken: string): Promise<AuthProviderUser> {
