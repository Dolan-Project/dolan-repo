...
const paths: Record<string, { outline: string; filled?: string }> = {
  ...
  close: {
    outline: "M18.3 5.71 12 12l6.3 6.29-1.41 1.42L10.59 13.41 4.29 19.71 2.88 18.29 9.17 12 2.88 5.71 4.29 4.29 10.59 10.59 16.89 4.29z",
  },
  arrow_forward: {
    outline: "m12 4-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z",
  },
  landscape: {
    outline: "m14 6-3.75 5 2.85 3.8-1.6 1.2-3.25-4.33L3 19h18z",
  },
  groups: {
    outline: "M16 11c1.66 0 3-1.34 3-3s-1.34-3-3-3c-.32 0-.63.05-.91.14.57.8.91 1.79.91 2.86s-.34 2.06-.91 2.86c.28.09.59.14.91.14zm-8 0c1.66 0 3-1.34 3-3S9.66 5 8 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5C15 14.17 10.33 13 8 13zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z",
  },
  group: {
